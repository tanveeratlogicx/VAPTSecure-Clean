...
| File | Role | Size |
|------|------|------|
| `enforcer_pattern_library_v2.0.json` | All 127 risks × all enforcer types — corrected code, driver sub-objects, Cloudflare/IIS/Caddy derivations | ~204 KB |
...
| File | Role | Size |
|------|------|------|
| `vapt_driver_manifest_v2.0.json` | Machine-executable instructions for all 127 risks — every field directly usable by the PHP driver | ~145 KB |
