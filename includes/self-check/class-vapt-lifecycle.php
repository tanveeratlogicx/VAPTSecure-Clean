...
class VAPT_Lifecycle {
    ...
    public static function on_uninstall(): void {
        ...
        if(defined('VAPTSECURE_PATH')) {
            $generated = VAPTSECURE_PATH . 'data/generated/';
            if ( is_dir($generated) ) {
    ...
    private static function create_tables(): void {
        ...
        $sql_features = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}vapt_features (
        ...
        $sql_audit = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}vapt_audit_log (
            id                  BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
